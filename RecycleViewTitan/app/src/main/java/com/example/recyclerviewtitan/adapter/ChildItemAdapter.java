...
public class ChildItemAdapter extends RecyclerView.Adapter<ChildItemAdapter.ChildViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ChildViewHolder childViewHolder, int position) {
        ...
        childViewHolder.ChildItenRate.setText(("Hp " + String.valueOf(childItem.getChildItemRate())));
    }
    ...
    class ChildViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView ChildItenRate;
        ChildViewHolder(View itemView) {
            super(itemView);
            ChildItemTitle  = itemView.findViewById(R.id.child_item_title);
            ChildItenRate = itemView.findViewById(R.id.child_item_rate);
        }
    }
}